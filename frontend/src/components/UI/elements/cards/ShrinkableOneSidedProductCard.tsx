...
/////COMPONENET/////COMPONENET/////COMPONENET/////COMPONENET/////
export default function ShrinkableOneSidedProductCard({
  children,
  _wrapperClassName,
  _title,
  _Location,
  ...
  return (
    ...
    >
      <div className="s-card">
        {/* /////CARD FRONT!///// */}
        <CardFrontFace
          _frontFaceClassNames="s-card__side s-card__side-front"
          _frontFacePicture="s-card__picture " //card__picture-img
          _cardHeading="s-card__heading"
          _inImgTitleClass="s-card__heading-span s-card__heading-span-img"
        ...
        >
          ...
          <TourCMDSButton
            _CDGoClass="s-card__details-go"
            _CDGoLClass="s-card__details-go_left"
            _CDGoLBClass="s-card__details-go_left-bit"
            _CDGoRClass="s-card__details-go_right"
            _srcInfo={InfoIcon}
          ...
          <div className="s-card__details-amenities"></div>
          {/* /////CARD FRONT DESCRIPTIONS DEAL///// */}

          <div className="s-card__details-deal"></div>

          {/* /////CARD FRONT DESCRIPTIONS///// */}
          <CardDescription
            _cardDetails="s-card__details noHover"
            _cardDescTitle="s-card__description"
            _cardDescLiner="s-card__description--liner"
...
/////////IMPORTS//////IMPORTS//////IMPORTS//////IMPORTS//////IMPORTS//////IMPORTS/////////
//@ts-ignore
import "./ShrinkableOneSidedProductCard.scss";
